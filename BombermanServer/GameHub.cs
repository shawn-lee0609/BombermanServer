...
namespace BombermanServer
{
    public class GameHub : Hub
    {
        ...
        public async Task BombExploded(string bombId, int x, int y,
            string destroyedCells)
        {
            await Clients.Others.SendAsync("OnBombExploded",
                bombId, x, y, destroyedCells);
        }
        ...
        {
            await Clients.Others.SendAsync("OnPlayerLeft",
